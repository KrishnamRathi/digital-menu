...
const Card = ({name, desc, price}) => {
    return (
        <View style={[common.shadow, { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', height: 100, borderRadius: 10, padding: 30}]}>
            <View style={{ flexDirection: 'row'}}>
                <Image source={require("../assets/icons/pizza.png")} style={{height: 60, width: 60}}/>
